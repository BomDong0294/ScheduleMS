...
public class EditSerialChecker extends JPanel{
	
	WindowFrame frame;
	ScheduleMethod schfunction;

	public EditSerialChecker(WindowFrame frame, ScheduleMethod schfunction) {
		this.frame = frame;
		...
		button1.addActionListener(new EditorListener(frame));
		panel2.add(button1);
